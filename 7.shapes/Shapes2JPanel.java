...
public class Shapes2JPanel extends JPanel 
{
   ...
   public void paintComponent( Graphics g )
   {
      ...
      Random random = new Random(); // obt�m o gerador de n�meros aleat�rios
      ...
      // cria a estrela -- isso n�o desenha a estrela
      ...
      // gira em torno da origem e desenha estrelas em cores aleat�rias
      for ( int count = 1; count <= 20; count++ ) 
      {
         g2d.rotate( Math.PI / 10.0 ); // rotaciona o sistema de coordenadas

         // configura cores aleat�rias
